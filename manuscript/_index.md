...
| 60 | (next chapter) | pending (next run) |

_Weekly audits run as separate runs and do NOT take a chapter number — chapter numbering is continuous, no gaps. Audit windows so far: Ch7–13, Ch14–20, Ch21–27, Ch28–34, Ch35–41, Ch42–48, Ch49–55 (every 7). The Ch49–55 audit is DONE (2026-08-09; all in notes/audit.md). Ch59 (the climb continues: Adz covers the next leg up out of the deep, passes the far man's cold fire spot (Ch37) in a single ghost-touch, and re-crosses the far man's rigged crossing-line (Ch36) backward — the same rope now meaning the last honest stranger's-work before the counting country; exposure a hair thicker in a fresh register — he catches himself counting days on the rope and puts it down; does not reach a lamp, a peopled stop, thick-signal country, the count, or his file, and does not get/name the number) is DONE. THE NEXT RUN writes Ch60 — see notes/state.md for the Ch60 seed and NEXT BEAT (the next leg of the climb, a down-trip landmark re-met backward, exposure a hair thicker again). Next audit window is Ch56–62 (after Ch62)._
