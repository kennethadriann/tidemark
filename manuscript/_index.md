...
| — | Ch56–62 weekly audit | pending (next run) |

_Weekly audits run as separate runs and do NOT take a chapter number — chapter numbering is continuous, no gaps. Audit windows so far: Ch7–13, Ch14–20, Ch21–27, Ch28–34, Ch35–41, Ch42–48, Ch49–55 (every 7). The Ch49–55 audit is DONE (2026-08-09; all in notes/audit.md). Ch62 (the climb continues: the lamps draw closer together and Adz reaches the SECOND far lamp, finding the first person-sign of the return — a banked-not-fresh kept fire off the light, tender absent, no contact; exposure a hair thicker in a fresh register — he catches himself MINDING WHAT HE LEAVES, brushing out his own prints, the count now working down into his hands, and sets it down; does not reach a third lamp, a peopled stop, thick-signal country, the top stop, the count, or his file, and does not get/name the number) is DONE. This completes the Ch56–62 window. THE NEXT RUN is the Ch56–62 WEEKLY AUDIT (read Ch56–62 + recap, write a drift check to notes/audit.md, do NOT write a chapter) — see notes/state.md. The run AFTER the audit writes Ch63._
