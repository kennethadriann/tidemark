...
| 57 | The Stair | done |
| 58 | The Way Back Up | done |
| 59 | Hand Over Hand | done |
| 60 | Up Out of It | done |
| 61 | The First of Them | done |
| 62 | (next chapter) | pending (next run) |

_Weekly audits run as separate runs and do NOT take a chapter number — chapter numbering is continuous, no gaps. Audit windows so far: Ch7–13, Ch14–20, Ch21–27, Ch28–34, Ch35–41, Ch42–48, Ch49–55 (every 7). The Ch49–55 audit is DONE (2026-08-09; all in notes/audit.md). Ch61 (the climb continues: Adz covers the next leg up the plain LONG RUN and re-meets the FIRST FAR LAMP (Ch33) from below — same flame over nothing, water in the cut hollow, nobody by it; exposure a hair thicker in a fresh register — the far lamp now reads "people soon / the way filling in" instead of Ch33's lonely "light on nothing," the lamps coming closer together the higher he climbs and totting off his approach to the counting country, and he steps out of the light to get back the habit of the edge; does not reach a second lamp, a peopled stop, thick-signal country, a lit trade stop, the count, or his file, and does not get/name the number) is DONE. THE NEXT RUN writes Ch62 — see notes/state.md for the Ch62 seed and NEXT BEAT (the next leg of the climb toward thick-signal country, exposure a hair thicker again). Next audit window is Ch56–62 (the Ch62 run is the last normal chapter before that audit)._
